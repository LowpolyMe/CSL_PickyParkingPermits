...
namespace PickyParking.Patching.TMPE
{
    internal static class TMPE_TrySpawnParkedPassengerCarPatch
    {
        ...
        {
            ParkingSearchContextSetupAdapter.BeginTrySpawnParkedCar(citizenId, ref __state);
        }


        private static Exception Finalizer(Exception __exception, bool __state)
        {
            return ParkingSearchContextSetupAdapter.EndTrySpawnParkedCar(__exception, __state);
        }
    }
}
